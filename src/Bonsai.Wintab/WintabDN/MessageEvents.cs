        ...
        private class MessageWindow : Form
        {
            ...
            protected override void WndProc(ref Message msg)
            {
                ...
                if (handlePacketMessage)
                {
                    ...
                    {
                        EventHandler<MessageReceivedEventArgs> handler = PacketMessageReceived;
                        if (handler != null)
                        {
                ...
                if (handleStatusMessage)
                {
                    _context.Post(delegate (object state)
                    {
                        EventHandler<MessageReceivedEventArgs> handler = StatusMessageReceived;
                        if (handler != null)
                        {
                            handler(null, new MessageReceivedEventArgs((Message)state));
                        }
                ...
                if (handleInfoChgMessage)
                {
                    _context.Post(delegate (object state)
                    {
                        EventHandler<MessageReceivedEventArgs> handler = InfoChgMessageReceived;
                        if (handler != null)
                        {
                            handler(null, new MessageReceivedEventArgs((Message)state));
                        }
