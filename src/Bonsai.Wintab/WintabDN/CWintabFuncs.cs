...
namespace WintabDN
{
    ...
    internal struct HWND
    {
        ...
        public HWND(P_HWND value)
        { this.value = value; }

        public static implicit operator P_HWND(HWND hwnd_I)
        { return hwnd_I.value; }

        public static implicit operator HWND(P_HWND ptr_I)
    ...
    internal class WTPKT
    {
        ...
        public WTPKT(P_FIX32 value)
        { this.value = value; }

        public static implicit operator P_FIX32(WTPKT pkt_I)
        { return pkt_I.value; }

        public static implicit operator WTPKT(P_FIX32 value)
    ...
    internal class FIX32
    {
        ...
        public FIX32(P_FIX32 value)
        { this.value = value; }

        public static implicit operator P_FIX32(FIX32 fix32_I)
        { return fix32_I.value; }

        public static implicit operator FIX32(P_FIX32 value)
    ...
    internal class HCTX
    {
        ...
        public HCTX(P_FIX32 value)
        { this.value = new P_HWND(value); }

        public static implicit operator P_FIX32(HCTX hctx_I)
        { return (P_FIX32)hctx_I.value.ToInt32(); }

        public static implicit operator HCTX(P_FIX32 value)
        { return new HCTX(value); }

        public static bool operator ==(HCTX hctx, P_FIX32 value)
        { return (P_FIX32)hctx.value.ToInt32() == value; }
    ...
    internal class CWintabFuncs
    {
        ...
        public static extern P_FIX32 WTInfoA(P_FIX32 wCategory_I, P_FIX32 nIndex_I, P_HWND lpOutput_O);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern P_FIX32 WTQueueSizeGet(P_HCTX hctx_I);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTQueueSizeSet(P_HCTX hctx_I, P_FIX32 nPkts_I);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTPacket(P_HCTX hctx_I, P_FIX32 pktSerialNum_I, P_HWND pktBuf_O);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern P_FIX32 WTPacketsGet(P_HCTX hctx_I, P_FIX32 maxPkts_I, P_HWND pktBuf_O);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern P_FIX32 WTDataGet(P_HCTX hctx_I, P_FIX32 pktIDStart_I, P_FIX32 pktIDEnd_I,
            P_FIX32 maxPkts_I, P_HWND pktBuf_O, ref P_FIX32 numPkts_O);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern P_FIX32 WTDataPeek(P_HCTX hctx_I, P_FIX32 pktIDStart_I, P_FIX32 pktIDEnd_I,
            P_FIX32 maxPkts_I, P_HWND pktBuf_O, ref P_FIX32 numPkts_O);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTQueuePacketsEx(P_HCTX hctx_I, ref P_FIX32 pktIDOldest_O, ref P_FIX32 pktIDNewest_O);
        ...
        /// <returns></returns>
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTExtGet(P_HCTX hctx_I, P_FIX32 extTag_I, P_HWND extData_O);
        ...
        /// <returns></returns>
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTExtSet(P_HCTX hctx_I, P_FIX32 extTag_I, P_HWND extData_I);
    }
}
